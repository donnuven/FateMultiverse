...
import * as schemas from "../../models/registrationSchema";
import * as userService from "../../services/userServices";

class RegisterPage extends React.Component {
  constructor(props) {
    super(props);
    this.validation = schemas.getRegistrationSchema;
    this.state = {
      squares1to6: "",
      squares7and8: ""
    };
  ...
  handleSubmit = (values, obj) => {
    userService
      .user_registrating(values, obj)
      .then(this.onUserRegistratingSuccess)
      .catch(this.onUserRegistratingError)
      .then(() => {
        obj.setSubmitting(false);
      });
  };

  onUserRegistratingSuccess = response => {
    console.log(response);
    console.log("User has been register");
    this.props.history.push("/login");
  };

  onUserRegistratingError = error => {
    console.log(error);
  };
